    ...
    <EditableSiteShell>
      <main className="bg-[var(--slot4-page-bg)] text-[var(--slot4-page-text)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[1440px] items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
          <div className="rounded-[2.2rem] border border-[#d7e3ef] bg-white p-6 shadow-[0_24px_70px_rgba(0,0,0,0.08)] backdrop-blur sm:p-8">
          ...
          <div className="rounded-[2.6rem] border border-[#d7e3ef] bg-[linear-gradient(180deg,#ffffff_0%,#eef5fc_100%)] p-8 shadow-[0_24px_70px_rgba(65,101,138,0.10)] sm:p-10">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#9b0f06]">{pagesContent.auth.signup.badge}</p>
            ...
            <p className="mt-6 max-w-lg text-lg leading-9 text-[#56718d]">{pagesContent.auth.signup.description}</p>
          </div>
        </section>
      </main>
    </EditableSiteShell>
